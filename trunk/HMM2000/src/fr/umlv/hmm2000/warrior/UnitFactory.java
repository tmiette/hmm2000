...
public class UnitFactory {
  ...
  public static Warrior createWarrior(FightableContainer container,
      ProfilWarrior profil, Level level) {

    final double ratio = level.getRatio();
    return new Warrior(container, profil.name(), profil.getSprite(), profil
