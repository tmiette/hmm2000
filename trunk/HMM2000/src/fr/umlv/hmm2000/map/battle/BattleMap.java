...
/**
 * This class represents a battle map. This map is useful when a battle starts
 * between two fightable container.
 * 
 * @author MIETTE Tom
...
public class BattleMap implements Map {
	...
	/**
	 * Initializes position team for each fightable container. The fightable
	 * container with fewer units is placed to the top of map.
	 * 
	 * @param c1
	 *          fightablecontainer containing troop
	 * @param c2
	 *          fightablecontainer containing troop
	 */
	private void initContainer(FightableContainer c1, FightableContainer c2) {

		// Getting the minimum and maximum container
	...
	/**
	 * Gets team which owns location.
	 * 
	 * @param l
	 *          location on map
	 * @return team which owns location
	 */
	...
	/**
	 * Gets fightable container which owns the given location.
	 * 
	 * @param l
	 *          location on map
	 * @return the fightable container on location
	 */
	...
	/**
	 * Swap fightable between opponent teams.
	 * 
	 * @param from
	 *          origin location
	 * @param to
