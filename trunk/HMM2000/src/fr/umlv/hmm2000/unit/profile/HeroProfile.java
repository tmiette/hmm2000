...
public enum HeroProfile {
	...
	LORD_OF_WAR(Sprite.LORDOFWAR,
							new Fightable[] { UnitFactory.createWarrior(WarriorProfile.GRUNT,
									Level.LEVEL_1) },
							new Skill[] { new SwapFightablesSkill(),
									new AttackOneMoreTimeSkill() },
							FightableContainer.PRIORITY_MEDIUM),
	SORCERER(	Sprite.SORCERER,
						new Fightable[] { UnitFactory.createWarrior(WarriorProfile.WIZZARD,
								Level.LEVEL_1) },
						new Skill[] {
	...
	private HeroProfile(	Sprite sprite,
											Fightable[] units,
											Skill[] skills,
											int attackPriority) {
