...
public class Hmm2000Seb {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		map2.addMapForegroundElement(	WarriorFactory.createWarrior(	ProfilHeroe.ARCHER,
																																p1,
																																"batman"),
																	new Location(	0,
																								0));
		map2.addMapForegroundElement(	WarriorFactory.createWarrior(	ProfilHeroe.LORD_OF_WAR,
																																p2,
																																"spiderman"),
																	new Location(	1,
																								2));
		map2.addMapForegroundElement(	new Resource(	Kind.GOLD,
																								10,
																								100,
																								1,
																								5),
		...
		m.addProduct(	Spell.OBSTACLE_DESTRUCTION,
									1);
		map2.addMapForegroundElement(	m,
																	new Location(	2,
																								2));
		...
		b.addProduct(	Spell.TELEPORTATION,
									1);
		map2.addMapForegroundElement(	b,
																	new Location(	2,
																								5));

		UIEngine board = new GameBoard(map2);
		Engine.createEngine(map2,
												board.uiEventManager());
		board.start();
