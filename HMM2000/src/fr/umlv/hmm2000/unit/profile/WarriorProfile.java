...
public enum WarriorProfile {
   ...
   */
  FLIGHT(Sprite.FLIGHT, 10, 10, 30, 50,
  ...
  GRUNT(Sprite.GRUNT, 20, 20, 50, 20,
      new ElementAbility().addAbility(ElementaryEnum.FIRE, 10, 10).addAbility(
          ElementaryEnum.LIGHTNING, 10, 10), new AttackBehaviour() {
  ...
  WIZZARD(Sprite.WIZZARD, 1, 1, 70, 10,
      new ElementAbility().addAbility(ElementaryEnum.FIRE, 10, 10).addAbility(
          ElementaryEnum.LIGHTNING, 10, 10), new AttackBehaviour() {
  ...
  VAMPIRE(Sprite.VAMPIRE, 10, 10, 30, 50,
      new ElementAbility().addAbility(ElementaryEnum.FIRE, 10, 10).addAbility(
          ElementaryEnum.LIGHTNING, 10, 10), new AttackBehaviour() {
  ...
  DEAMON(Sprite.DEAMON, 20, 20, 50, 20,
      new ElementAbility().addAbility(ElementaryEnum.FIRE, 10, 10).addAbility(
          ElementaryEnum.LIGHTNING, 10, 10), new AttackBehaviour() {
  ...
  private WarriorProfile(Sprite sprite, double physicalAttackValue,
