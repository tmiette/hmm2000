...
public interface Map {
	 ...
	 * @param l location where element should be added
	 */
	 ...
	 * @param l location where backgroung should be
	 ...
	 * @param l location where map forground should be
	 ...
	 * @param l location where map foreground element should be deleted 
	 */
	public void removeMapForegroundElement(Location l);

	/**
	 * Replaces map background element at given location by the given map background element.
	 * @param l location of the new map background element
	 * @param element map background element to add to the map
	 */
